  ...
  return (
    <div className="max-w-2xl mx-auto my-12 px-6 text-center">
      <p className="text-lg text-gray-700 leading-relaxed">
        BackBook is a platform where you can create, edit, and delete blog
        posts. View all your posts in one place, log in, and start sharing your
        thoughts with the world! We are constantly growing and would love you to
